...
export const updateDestinationSchema = createDestinationSchema.partial().refine(
...
export type DestinationPaginationInput = z.infer<typeof destinationPaginationSchema>;
